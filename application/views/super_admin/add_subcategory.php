                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <div class="row">
                            ...
                            <form action="<?php echo base_url(); ?>super_admin/save_subcategory" method="POST" data-toggle="validator" role="form" class="form-horizontal form-label-left">
                                <div class="col-md-8">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <input type="text" name="category_name" required value="<?php echo set_value('category_name'); ?>" data-error="Enter Subcategory" class="form-control col-md-7 col-xs-12">
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        <div class="control-label pull-right">
                                            <button id="send" type="submit" class="btn btn-dark">Save Sub Category</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
